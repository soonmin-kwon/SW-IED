...
// Framework setting
#define _DIST_TARGET 155  // [20213080] 멈추려는 목표거리 정의
...
// Servo range
#define _DUTY_MIN 553    // [20213060] 서보 duty 최소값
#define _DUTY_NEU 1476    // [20213064] 서보 duty 중간값
#define _DUTY_MAX 2399    // [20213079] 서보 duty 최댓값
...
////////////////////
  ...
  if(event_serial) {
    ...
    Serial.println(",Min:100,Low:200,dist_target:155,High:310,Max:410"); // [20213071] 
